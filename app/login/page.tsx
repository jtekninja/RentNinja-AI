            ...
            <div className="space-y-6">
              <div className="space-y-4">
                ...
                <h1 className="text-3xl md:text-4xl lg:text-5xl font-semibold tracking-tight text-white">
                  Return to your applicant pipeline and choose the best tenant
                  with less guesswork.
                </h1>
                <p className="max-w-xl text-base text-slate-300">
                  RentNinja AI gives each operator a private screening workspace
                  to rank applicants, catch red flags early, and move from
                  inquiry to lease decision with a cleaner process.
                </p>
              </div>
            </div>
